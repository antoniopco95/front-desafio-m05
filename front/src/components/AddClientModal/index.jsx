...
export default function AddClientModal({ openAdd, handleCloseAdd }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const emailExists = clientsData.some((client) => client.email === inputEmail);
        ...
        const cpfExists = clientsData.some((client) => client.cpf === unformattedInputCpf);
        ...
        try {
            ...
            const res = await registerUserFecth.post("/create-cliente", newClient, config);
                ...
                <Box className='add-box' sx={style}>
                    <form className='addclientmodal-box'>
                        ...
                        <div className='addclientmodal-textfield'>
                            ...
                            {showErrorName && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '8.4px', marginTop: '4.2px' }}>{errorMessageName}</p>}
                        </div>
                        <div className='addclientmodal-textfield'>
                            ...
                            <input
                                ...
                                value={inputEmail}
                                className={`addclientmodal-input ${showErrorEmail ? 'border-red' : ''}`} placeholder='Digite seu e-mail' type="email" id='email' />
                            {showErrorEmail && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '8.4px', marginTop: '4.2px' }}>{errorMessageEmail}</p>}
                        </div>
                        <div className='addclientmodal-telandcpf'>
                            <div className='addclientmodal-textfield middle'>
                                ...
                                <IMaskInput
                                    ...
                                    type="text" id='cpf'
                                    mask="000.000.000-00" />
                                {showErrorCpf && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '8.4px', marginTop: '4.2px' }}>{errorMessageCpf}</p>}
                            </div>
                            <div className='addclientmodal-textfield'>
                                ...
                                {showErrorPhone && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '8.4px', marginTop: '4.2px' }}>{errorMessagePhone}</p>}
                            </div>
                        </div>
                        ...
                        <div className='addclientmodal-textfield'>
                            ...
                            <input
                                ...
                                value={address}
                                className='addclientmodal-input' placeholder='Digite o endereço' type="text" id='endereco' />
                        </div>
                        <div className='addclientmodal-textfield'>
                            ...
                            <input
                                ...
                                className='addclientmodal-input' placeholder='Digite o complemento' type="text" id='complemento' />
                        </div>
                        ...
                        <div className='addclientmodal-telandcpf'>
                            <div className='addclientmodal-textfield middle'>
                                ...
                                <IMaskInput
                                    ...
                                    value={cep}
                                    className='addclientmodal-input middle-input-both' placeholder='Digite o CEP' type="text" id='cep' mask="00000-000" />
                            </div>
                            <div className='addclientmodal-textfield'>
                                ...
                                <input
                                    ...
                                    value={neighborhood}
                                    className='addclientmodal-input middle-input-both' placeholder='Digite o bairro' type="text" id='bairro' />
                            </div>
                        </div>
                        <div className='addclientmodal-telandcpf'>
                            <div className='addclientmodal-textfield middle'>
                                ...
                                <input
                                    ...
                                    value={city}
                                    className='addclientmodal-input middle-city' placeholder='Digite a cidade' type="text" id='city' />
                            </div>
                            <div className='addclientmodal-textfield'>
                                ...
                                <input
                                    ...
                                    value={uf}
                                    className='addclientmodal-input middle-uf' placeholder='Digite a UF' type="text" id='uf' maxLength='2' />
                            </div>
                        </div>
                        <div className='addclientmodal-buttons'>
                            ...
                            <button onClick={handleSubmit} className='addclientmodal-button' type='submit' id='aplicar'>Aplicar</button>
                        </div>
                    </form>
                </Box>
            </Modal>
