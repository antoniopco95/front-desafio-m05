...
export default function CreateCharges({ openCreateCharges, handleCloseCreateCharges, handleClickSnack, setCustomMessageApprove, inputChargeName }) {
    ...
    const handleSubmit = async (e) => {
        ...
        let formattedDate = format(new Date(inputChargeExpire.substr(6, 4), inputChargeExpire.substr(3, 2), inputChargeExpire.substr(0, 2)), 'yyyy/MM/dd');

        try {
            const response = await registerUserFecth.post('/create-charge', {
                        ...
                        <div>
                            ...
                            <div className='createcharges-inputandp'>
                                ...
                                <input
                                    ...
                                    className='createcharges-input' type="text" placeholder='Digite o nome' />
                            </div>
                            <div className='createcharges-inputandp'>
                                ...
                                <textarea
                                    ...
                                    className={`createcharges-input createcharges-desc ${errorChargeDesc ? 'border-red' : ''}`} type="text" placeholder='Digite a descrição' size='100' />
                                {errorChargeDesc && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '14px', marginTop: '6px' }}>Este campo deve ser preenchido</p>}
                            </div>
                            <div>
                                <div className='createcharges-valueandexpire'>
                                    <div className='createcharges-inputandp'>
                                        ...
                                        <IMaskInput
                                            ...
                                            className={`createcharges-input createcharges-middleinput ${errorChargeExpire ? 'border-red' : ''}`} type="text" placeholder='Data de Vencimento' mask="00/00/0000" />
                                        {errorChargeExpire && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '14px', marginTop: '6px' }}>Este campo deve ser preenchido</p>}
                                    </div>
                                    <div className='createcharges-inputandp'>
                                        ...
                                        <input
                                            ...
                                            className={`createcharges-input createcharges-middleinput ${errorChargeValue ? 'border-red' : ''}`} type="text" placeholder='Digite o valor' />
                                        {errorChargeValue && <p style={{ color: 'red', fontFamily: 'Nunito', fontSize: '14px', marginTop: '6px' }}>Este campo deve ser preenchido</p>}
                                    </div>
                                </div>
                                <div className='createcharges-inputandp'>
                                    ...
                                    <div className='createcharges-inputandradio'>
                                        <Radio checked={selectedValue === 'a'}
                                            ...
                                            value="a"
                                            name="radio-buttons" inputProps={{ 'aria-label': 'A' }} checkedIcon={<BpCheckedIcon />}
                                            icon={<BpIcon />} />
                                    ...
                                    <div className='createcharges-inputandradio'>
                                        <Radio checked={selectedValue === 'b'}
                                            onChange={handleChange}
                                            value="b"
                                            name="radio-buttons" inputProps={{ 'aria-label': 'B' }} checkedIcon={<BpCheckedIcon />}
                                            icon={<BpIcon />} />
