...
const SignUp = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', overflow: 'hidden' }}>
            ...
            >
                <Stepper activeStep={activeStep} orientation="vertical" sx={{ display: 'flex', gap: '10px' }} connector={null}>
                    {steps.map((step, index) => (
                        <Step key={step.label} sx={{ height: '120px', marginBottom: '5px' }}>
                            <StepLabel
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            {activeStep < steps.length - 1 && (
                                <div style={{
                                    ...
                                    >
                                        {activeStep === steps.length - 2 ? 'Finalizar Cadastro' : 'Continuar'}
                                    </Button>
                                    {activeStep === 0 && (
                                        <span style={{
                                            display: 'flex',
